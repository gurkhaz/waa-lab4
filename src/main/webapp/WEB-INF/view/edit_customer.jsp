		...
		<div class="row">
			...
			<div class="form" style="margin: auto;">
				<div class="form-group row">
					...
					<div class="col-4">
						<form:input path="userName" class="form-control" type="text" value="${customer.userName}" />
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-4">
						<form:input path="address" class="form-control" type="text" value="${customer.address}" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-4">
						<form:input path="dateOfBirth" class="form-control" type="text"  value="${customer.dateOfBirth}"/>
				...
				<div class="form-group row">
					...
					<div class="col-4">
						<form:input path="sex" class="form-control" type="text" value="${customer.sex}" />
					</div>
				</div>
